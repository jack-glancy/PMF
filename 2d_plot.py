...
#### Specify lists for rc1, rc2 and free energy values
...
#### plot the contours and the colour filled contours. Extend=both extends the colour map to cover the grid. Vmax specifies top limit on colourmap for energy.
...
# contour labels when clicked on
